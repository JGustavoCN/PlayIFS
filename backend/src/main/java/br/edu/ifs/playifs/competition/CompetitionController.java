...
public class CompetitionController {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Competições encontradas"), @ApiResponse(responseCode = "404", ref = "#/components/responses/NotFoundError")})
    @IsAuthenticated
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "201", description = "Competição criada com sucesso") })
    @IsCoordinator
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Competição atualizada"), @ApiResponse(responseCode = "404", ref = "#/components/responses/NotFoundError") })
    @IsCoordinator
    ...
    @Operation(summary = "Apaga uma competição (Apenas Coordenador)", description = "A operação falhará se a competição já possuir equipas inscritas.")
