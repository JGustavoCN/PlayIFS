...
public class AthleteController {
    ...
    @IsAuthenticated
    public ResponseEntity<AthleteDTO> findById(@Parameter(description = "ID do atleta a ser buscado") @PathVariable Long id) {
    ...
    @SecurityRequirements({}) // Remove a segurança padrão apenas para este endpoint
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Atleta cadastrado com sucesso"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Atleta apagado com sucesso"),
            @ApiResponse(responseCode = "403", ref = "#/components/responses/ForbiddenError"),
            @ApiResponse(responseCode = "404", ref = "#/components/responses/NotFoundError"),
            @ApiResponse(responseCode = "422", ref = "#/components/responses/UnprocessableEntityError")
    })
