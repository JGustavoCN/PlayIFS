...
@override
String toString() {
  return 'TeamStandingDTO(teamId: $teamId, teamName: $teamName, points: $points, wins: $wins, goalsFor: $goalsFor, goalsAgainst: $goalsAgainst, goalDifference: $goalDifference, gamesPlayed: $gamesPlayed, draws: $draws, losses: $losses)';
}
...
/// @nodoc
abstract mixin class $TeamStandingDTOCopyWith<$Res>  {
  factory $TeamStandingDTOCopyWith(TeamStandingDTO value, $Res Function(TeamStandingDTO) _then) = _$TeamStandingDTOCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$TeamStandingDTOCopyWithImpl<$Res>
    implements $TeamStandingDTOCopyWith<$Res> {
  _$TeamStandingDTOCopyWithImpl(this._self, this._then);

  final TeamStandingDTO _self;
  final $Res Function(TeamStandingDTO) _then;
...
/// Adds pattern-matching-related methods to [TeamStandingDTO].
extension TeamStandingDTOPatterns on TeamStandingDTO {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TeamStandingDTO value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TeamStandingDTO() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TeamStandingDTO value)  $default,){
final _that = this;
switch (_that) {
case _TeamStandingDTO():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TeamStandingDTO value)?  $default,){
final _that = this;
switch (_that) {
case _TeamStandingDTO() when $default != null:
return $default(_that);case _:
...
class _TeamStandingDTO implements TeamStandingDTO {
  const _TeamStandingDTO({required this.teamId, required this.teamName, required this.points, required this.wins, required this.goalsFor, required this.goalsAgainst, required this.goalDifference, this.gamesPlayed, this.draws, this.losses});
  factory _TeamStandingDTO.fromJson(Map<String, dynamic> json) => _$TeamStandingDTOFromJson(json);
...
@pragma('vm:prefer-inline')
_$TeamStandingDTOCopyWith<_TeamStandingDTO> get copyWith => __$TeamStandingDTOCopyWithImpl<_TeamStandingDTO>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TeamStandingDTOToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TeamStandingDTO&&(identical(other.teamId, teamId) || other.teamId == teamId)&&(identical(other.teamName, teamName) || other.teamName == teamName)&&(identical(other.points, points) || other.points == points)&&(identical(other.wins, wins) || other.wins == wins)&&(identical(other.goalsFor, goalsFor) || other.goalsFor == goalsFor)&&(identical(other.goalsAgainst, goalsAgainst) || other.goalsAgainst == goalsAgainst)&&(identical(other.goalDifference, goalDifference) || other.goalDifference == goalDifference)&&(identical(other.gamesPlayed, gamesPlayed) || other.gamesPlayed == gamesPlayed)&&(identical(other.draws, draws) || other.draws == draws)&&(identical(other.losses, losses) || other.losses == losses));
}
...
/// @nodoc
abstract mixin class _$TeamStandingDTOCopyWith<$Res> implements $TeamStandingDTOCopyWith<$Res> {
  factory _$TeamStandingDTOCopyWith(_TeamStandingDTO value, $Res Function(_TeamStandingDTO) _then) = __$TeamStandingDTOCopyWithImpl;
@override @useResult
$Res call({
 int teamId, String teamName, int points, int wins, int goalsFor, int goalsAgainst, int goalDifference, int? gamesPlayed, int? draws, int? losses
});
...
/// @nodoc
class __$TeamStandingDTOCopyWithImpl<$Res>
    implements _$TeamStandingDTOCopyWith<$Res> {
  __$TeamStandingDTOCopyWithImpl(this._self, this._then);

  final _TeamStandingDTO _self;
  final $Res Function(_TeamStandingDTO) _then;
